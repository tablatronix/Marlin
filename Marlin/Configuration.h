...
#define Z_PROBE_FEEDRATE_FAST _HOMING_FEEDRATE_Z // 8*60=480
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  // #define MIN_SOFTWARE_ENDSTOP_Z //bl touch
#endif
...
// THIS SETS THE HOME REGISTERED POSITION, OVERRIDES automatic which is set by BED_MIN, IT DOES NOT MOVE HOME
// Manually set the home position. Leave these undefined for automatic settings.
// For DELTA this is the top-center of the Cartesian print volume.
//#define MANUAL_X_HOME_POS 0
#define MANUAL_Y_HOME_POS ENDER_3_Y_OFFSET
...
// Homing speeds (mm/m)
#define _HOMING_FEEDRATE_XY (30*60)
#define _HOMING_FEEDRATE_Z  (8*60)
#define HOMING_FEEDRATE_MM_M { _HOMING_FEEDRATE_XY, _HOMING_FEEDRATE_XY, _HOMING_FEEDRATE_Z }
